...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { name: 'Phiên hoàn thành', value: '18', icon: '✅' },
    { name: 'Phiên sắp tới', value: '6', icon: '⏰' },
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">Hôm qua, 14:00 - 16:00</p>
                </div>
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">Ngày mai, 09:00 - 11:00</p>
                </div>
